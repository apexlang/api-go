...
type Error struct {
	...
	Timestamp time.Time `json:"timestamp,omitempty" yaml:"timestamp,omitempty" msgpack:"timestamp,omitempty"`
}
...
func Wrapf(err error, code ErrCode, format string, args ...interface{}) *Error {
